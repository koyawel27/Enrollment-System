...
<head>
    ...
    <title>My Profile - BPC iEnroll</title>
    <style>
...
<div class="dashboard-container">
    ...
    <main class="main-content">
        <div class="page-header">
            <h1>My Profile</h1>
            <p>Review your personal and contact information.</p>
        </div>
        ...
        <div class="card">
            ...
            <div class="detail-grid">
                <div>
                    ...
                    <div class="detail-value">
                        ...
                        if ($app) {
                            ...
                            echo '<span class="detail-value muted">Not yet provided</span>';
                        }
                        ?>
                    </div>
                </div>
                <div>
                    ...
                    <div class="detail-value"><?php echo htmlspecialchars($app['sex'] ?? '—'); ?></div>
                </div>
                <div>
                    ...
                    <div class="detail-value">
                        ...
                        if (!empty($app['date_of_birth'])) {
                            echo htmlspecialchars(date('F d, Y', strtotime($app['date_of_birth'])));
                        } else {
                            echo '—';
                        }
                        ?>
                ...
                <div>
                    ...
                    <div class="detail-value"><?php echo htmlspecialchars($app['age'] ?? '—'); ?></div>
                </div>
                <div>
                    <div class="detail-label">Citizenship</div>
                    <div class="detail-value"><?php echo htmlspecialchars($app['citizenship'] ?? '—'); ?></div>
                </div>
                <div>
                    <div class="detail-label">Civil Status</div>
                    <div class="detail-value"><?php echo htmlspecialchars($app['civil_status'] ?? '—'); ?></div>
                </div>
                <div>
                    <div class="detail-label">Religion</div>
                    <div class="detail-value"><?php echo htmlspecialchars($app['religion'] ?? '—'); ?></div>
                </div>
            </div>
        </div>

        <div class="card">
            <div class="card-title">Contact & Address</div>
            <div class="detail-grid">
                <div>
                    <div class="detail-label">Email</div>
                    <div class="detail-value"><?php echo htmlspecialchars($app['email'] ?? $user_email); ?></div>
                </div>
                <div>
                    <div class="detail-label">Mobile Number</div>
                    <div class="detail-value"><?php echo htmlspecialchars($app['mobile_number'] ?? '—'); ?></div>
                </div>
                <div>
                    <div class="detail-label">Facebook</div>
                    <div class="detail-value"><?php echo htmlspecialchars($app['facebook'] ?? '—'); ?></div>
                </div>
                <div style="grid-column:1 / -1;">
                    ...
                    <div class="detail-value">
                        ...
                        if ($app) {
                            echo htmlspecialchars(trim(
                                ($app['current_house_street'] ?? '') . ', ' .
                                ($app['current_barangay'] ?? '') . ', ' .
                                ($app['current_city'] ?? '') . ', ' .
                                ($app['current_province'] ?? '') . ' ' .
                                ($app['current_zip_code'] ?? '')
                            ));
                        } else {
                            echo '—';
                        }
                ...
                <div style="grid-column:1 / -1;">
                    ...
                    <div class="detail-value">
                        ...
                        if ($app) {
                            echo htmlspecialchars(trim(
                                ($app['permanent_house_street'] ?? '') . ', ' .
                                ($app['permanent_barangay'] ?? '') . ', ' .
                                ($app['permanent_city'] ?? '') . ', ' .
                                ($app['permanent_province'] ?? '') . ' ' .
                                ($app['permanent_zip_code'] ?? '')
                            ));
                        } else {
                            echo '—';
                        }
        ...
        <p style="font-size:0.85rem; color:var(--text-gray); margin-top:0.5rem;">
            To update your information, go to <a href="application-form.php" style="color:var(--bpc-green); text-decoration:none;"><strong>My Application</strong></a>
            if the application period is still open.
        </p>
    </main>
</div>
